...
static NSString * const SHKEvernoteUserStoreURL = @"";
static NSString * const SHKEvernoteConsumerKey = @"";
static NSString * const SHKEvernoteSecretKey = @"";
static NSString * const SHKEvernoteNetStoreURLBase = @"";
